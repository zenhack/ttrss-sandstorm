...
class Pref_Mobile extends Handler_Protected {
    function index() {
	  ...
	  print "<h2>Android</h2>";
      print "<ul>";
      print "<li>Download the official Tiny Tiny RSS app on <a href=\"https://play.google.com/store/apps/details?id=org.fox.ttrss\" target=\"_blank\">Google Play</a>.</li>";
	  ...
	  print "<h2>Windows</h2>";
	  print "<ul>";
	  print "<li>Download the Tiny Tiny RSS Reader app found on the <a href=\"https://www.microsoft.com/store/apps/9wzdncrdmbn3\" target=\"_blank\">Windows Store</a>. This app has been tested to work with Sandstorm on Windows 10 mobile and desktop. Note: The Windows 8.1 version does not work with Sandstorm.</li>";
	  print "<li>In the header bar of this site, you should see a key icon (you may need to open the menu). Click the key icon and create a new key. Save the webkey URL it gives you.</li>";
